...
namespace DATNWEB.Areas.Admin.Controllers
{
    public class SanPhamsController : BaseController
    {
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,DonGia,NgayCapNhat,CauHinh,MoTa,HinhAnh,SoLuongTon,TinhTrang,MaNCC,MaNSX,MaLoaiSP,HinhAnh1,HinhAnh2,HinhAnh3")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
